  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 250, 250, 0.57);borderRadius:10px">
        <h1 class="h1" style="color:rgba(81, 163, 81, 1);fontSize:28px;">汽车保养系统小程序注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210109/e702e3d18f9f4038a3a5f0594ee72e98.jpg");
		height: 100vh;
