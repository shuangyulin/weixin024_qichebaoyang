  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="员工姓名" prop="yuangongxingming">
              <el-input v-model="ruleForm.yuangongxingming" 
                placeholder="员工姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="员工性别" prop="yuangongxingbie">
          <el-select v-model="ruleForm.yuangongxingbie" placeholder="请选择员工性别">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="员工性别" prop="yuangongxingbie">
	      <el-input v-model="ruleForm.yuangongxingbie"
                placeholder="员工性别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.yuangongtupian" label="员工图片" prop="yuangongtupian">
          <file-upload
          tip="点击上传员工图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.yuangongtupian?ruleForm.yuangongtupian:''"
          @change="yuangongtupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.yuangongtupian" label="员工图片" prop="yuangongtupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yuangongtupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  data() {
	...
	yuangongxingbie : false,
	lianxidianhua : false,
	yuangongtupian : false,
      },
            ruleForm: {
                	        mendianmingcheng: '',
	                        	        yuangonggonghao: '',
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuangongxingming = true;
            continue;
	            	            ...
	            	            if(o=='yuangongxingbie'){
            this.ruleForm.yuangongxingbie = obj[o];
	    this.ro.yuangongxingbie = true;
            continue;
          }
	            	            if(o=='lianxidianhua'){
	    ...
	    this.ro.lianxidianhua = true;
            continue;
	            	            ...
	            	            if(o=='yuangongtupian'){
            this.ruleForm.yuangongtupian = obj[o];
	    this.ro.yuangongtupian = true;
            continue;
          }
	                    }
                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yuangongxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yuangongxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                ...
                this.ruleForm.yuangongtupian = fileUrls;
				this.addEditUploadStyleChange()
            },
            	addEditStyleChange() {
	  this.$nextTick(()=>{
