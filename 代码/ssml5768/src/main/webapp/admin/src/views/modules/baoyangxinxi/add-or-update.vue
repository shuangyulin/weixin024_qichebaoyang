<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="保养编号" prop="baoyangbianhao">
            <el-input v-model="ruleForm.baoyangbianhao" 
                placeholder="保养编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baoyangbianhao" label="保养编号" prop="baoyangbianhao">
              <el-input v-model="ruleForm.baoyangbianhao" 
                placeholder="保养编号" readonly></el-input>
          </el-form-item>
        </div>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="保养名称" prop="baoyangmingcheng">
          <el-input v-model="ruleForm.baoyangmingcheng" 
              placeholder="保养名称" clearable  :readonly="ro.baoyangmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="保养名称" prop="baoyangmingcheng">
              <el-input v-model="ruleForm.baoyangmingcheng" 
                placeholder="保养名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="保养信息" prop="baoyangxinxi">
          <el-input v-model="ruleForm.baoyangxinxi" 
              placeholder="保养信息" clearable  :readonly="ro.baoyangxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="保养信息" prop="baoyangxinxi">
              <el-input v-model="ruleForm.baoyangxinxi" 
                placeholder="保养信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xiangguantupian" label="相关图片" prop="xiangguantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.xiangguantupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="有效期" prop="youxiaoqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.youxiaoqi" 
                type="date"
                placeholder="有效期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.youxiaoqi" label="有效期" prop="youxiaoqi">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	baoyangbianhao : false,
	baoyangmingcheng : false,
	baoyangxinxi : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='baoyangbianhao'){
            this.ruleForm.baoyangbianhao = obj[o];
	    this.ro.baoyangbianhao = true;
            continue;
          }
	            	            if(o=='baoyangmingcheng'){
            this.ruleForm.baoyangmingcheng = obj[o];
	    this.ro.baoyangmingcheng = true;
            continue;
          }
	            	            if(o=='baoyangxinxi'){
            this.ruleForm.baoyangxinxi = obj[o];
	    this.ro.baoyangxinxi = true;
            continue;
          }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `baoyangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.baoyangxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
